...
\normalsize   BSc. Biology \\ % Your institution
\normalsize   MSc. Cancer Stem cells \& Developmental biology (hons)\\ % Your institution
...
The integration of complex datasets is needed to understand the complex biology of cancer better\cite{Munoz2011}, but is restricted by these limitations.
\medskip
