...
\begin{abstract}
\noindent
Effects of structural variation in the non-coding regions of the human genome are rarely studied, which is in strong contrast to their known role in disease\cite{Weischenfeldt2013}. Systematic approaches for elucidating their functional effects are rarely successful, mainly due to the complexity of non-coding regions (e.g. \textit{cis}- and \textit{trans}-acting elements, co-activation, non-coding RNA interaction). Predictions on functionality are further complicated by the diversity of types and consequences of structural variants. Integration and visualisation of complex, multi-layered datasets are needed to better understand the functional effects of these events\cite{Munoz2011}.
\medskip
...
During my Masters studies, I have already implemented graph-based methods for different purposes. As an illustration of the strengths of multilayer network-analysis, I describe a small example from the work I have done as an intern at the Sanger Institute\footnote{Unpublished data, discretion appreciated.}. Furthermore, we show trough a pilot-study the added efficiency of our proposed methods.
...
The research group of Dr. W. Kloosterman of the UMC Utrecht has genomic, epigenomic (HiC) and transcriptomic data available from patients (including relatives) with chromotripsis: since this event results in a extremely large number of SVs\cite{Kloosterman2014}, it is a very valuable data-resource for us. Identified SVs will be linked to TGCA data, as wells as to pathway-resources (i.e. GO, KEGG, Reactome). Finding perturbed pathways due to changes in transcription by non-coding SVs is one of the most favourable results from this theme.
\medskip
...
Apart from data with a diseased state, it would also be very valuable to analyse non-coding SVs in healthy individuals. Recently published papers by Huch et al. and Behjati et al.\cite{Huch2014,Behjati2014} show that the are cell/lineage-specific differences in mutational patterns of Organoids, derived from normal stem cells. With upcoming data of Organoids, derived from stem cells of young and old individuals, we will be in the position to identify the effects of non-deleterious non-coding structural variants.
%\medskip
%
%\noindent
...
\begin{gantt}[xunitlength=0.5cm,fontsize=\scriptsize,titlefontsize=\small,drawledgerline=true]{28}{13}
    \begin{ganttitle}
      \titleelement{2015}{2}
      \numtitle{2016}{1}{2017}{4}
      \titleelement{2018}{3}
    \end{ganttitle}
%    \begin{ganttitle}
%      \numtitle{3}{1}{4}{1}
...
%      \numtitle{1}{1}{3}{1}
%    \end{ganttitle}
    \ganttgroup{Development of graph-based integration methods}{1}{9}
    \ganttbar[color=DIOblauw]{Improving data-conversion to triplestores}{1}{5}
    \ganttbar[color=DIOblauw]{Find and setup of optimal triplestore-storage and query engine}{3}{5}
    \ganttbar[color=DIOblauw]{Developing best-practices for graph-based integration of nc-SV}{5}{3}
    \ganttgroup{Visualisation and analytics}{2}{8}
    \ganttbar[color=DIOrood]{Improving and/or developing mix-and-match RDF-explorer}{2}{6}
    \ganttbar[color=DIOrood]{Adding visual analytics and code-less SPARQL}{6}{4}
    \ganttgroup{Recurrent non-coding SVs in public databases}{2}{3}
    \ganttbar[color=DIOgroen]{Finding co-segregated 'omics signals within region-CNV}{2}{1}
    \ganttbar[color=DIOgroen]{Linking found signals to other databases}{2}{2}
        \ganttbar[color=DIOgroen]{\textit{In silico} analysis of linked signals and downstream effects}{3}{1}
     \ganttbar[color=DIOgroen]{\textit{In vitro} validation}{4}{1}
    \ganttgroup{Identify effects of Chromotripsis-induced SVs}{5}{3}  
    \ganttbar[color=DIOgroen]{Identifying mRNA- and epigenome-perturbations due to nc-SVs}{5}{1}
        \ganttbar[color=DIOgroen]{Linking found transcripts and epigenome-regions to pathways}{5}{2}
        \ganttbar[color=DIOgroen]{\textit{In silico} analysis of linked signals and downstream effects}{6}{1}
     \ganttbar[color=DIOgroen]{\textit{In vitro} validation}{7}{1}
    \ganttgroup{Single-cell analysis of SVs in cancer sub-populations}{6}{4} 
    \ganttbar[color=DIOgroen]{Data acquisition and sub-population identification}{6}{1}
\ganttbar[color=DIOgroen]{Linking nc-SVs to transcriptome-perturbations}{6}{2}
    \ganttbar[color=DIOgroen]{Linking to public (pathway, target \& ontology) repositories}{7}{2}
        \ganttbar[color=DIOgroen]{\textit{In silico} analysis of linked signals and downstream effects}{8}{1}
     \ganttbar[color=DIOgroen]{\textit{In vitro} validation}{9}{1}    
    \ganttgroup{Study non-coding SVs in healthy individuals/cells}{8}{4}        
    \ganttbar[color=DIOgroen]{Linking nc-SVs to public (cancer, pathway, target \& ontology) repositories}{8}{2}
        \ganttbar[color=DIOgroen]{\textit{In silico} analysis of linked signals and downstream effects}{10}{1}
     \ganttbar[color=DIOgroen]{\textit{In vitro} validation}{11}{1}
...
%%\end{multicols}
\newpage
\section*{Summary of MSc-diploma}
\includepdf[pages={-}]{/Users/robin/Dropbox/Studie/PhD_Proposal/BIF/4a.\ Major\_Diplom.pdf}
...
%photocopies of university entrance qualification or high school-leaving exam certificate, (e.g. Abitur, A-levels, Baccalaureat);
