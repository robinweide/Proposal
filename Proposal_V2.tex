...
\begin{itemize}
\item Non-coding: lastig en weinig onderzocht
\item Grootste winst is te halen in het combineren van lagen (distant relationships)
\item Distant relationships vindt je het makkelijkst met een graph
\item Er is veel data om te gebuiken! Maar het is wel erg veel... en heterogeen
\end{itemize}
